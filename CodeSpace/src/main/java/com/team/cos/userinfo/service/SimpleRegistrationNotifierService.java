...
public class SimpleRegistrationNotifierService {
	...
	public void sendMail(UserInfoVo userInfoVo) {
		...
		String homePage = "<div style=\"height:300px; margin:15% auto; width:20%\">\r\n"
				...
				+ "        <button style=\"border: 0px; margin: 10% 21%; height: 50px; width: 300px; align-items: center; border-radius: 5px; background-color: #007bff; border-color: #007bff; font-size: 20px; color: white; cursor: pointer;\"><a href=\"\" style=\"color: white; text-decoration: none\">홈페이지로 이동하기</a></button>\r\n"
