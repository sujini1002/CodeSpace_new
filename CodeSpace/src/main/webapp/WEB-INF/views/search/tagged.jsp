	...
	<div class="container">
		...
		<div class="list-container">
			...
			<c:if test="${!empty list}">
				...
				<c:if test="${fn:trim(tag) ne '' and tag ne null}">
					<div class="result-list">
						<h4>검색 태그 : [${tag}]</h4>
						<br>
						<h5>"${tag}"에 대한 ${pageMaker.totalCount}개의 태그 검색 결과</h5>
						<hr class="top-hr">
								...
								<ul class="pagination justify-content-center">
									<c:if test="${pageMaker.prev}">
										<li class="page-item"><a class="page-link"
											href="${pageContext.request.contextPath}/search/tagged${pageMaker.makeTag(pageMaker.startPage - 1)}">&laquo;</a></li>
									</c:if>
									...
									<c:forEach begin="${pageMaker.startPage}"
										...
										<li class="page-item"
											...
											<a class="page-link"
											href="${pageContext.request.contextPath}/search/tagged${pageMaker.makeTag(idx)}">${idx}</a>
										</li>
									</c:forEach>

									<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
										<li class="page-item"><a class="page-link"
											href="${pageContext.request.contextPath}/search/tagged${pageMaker.makeTag(pageMaker.endPage + 1)}">&raquo;</a></li>
									</c:if>
								</ul>
							</div>
						</div>
