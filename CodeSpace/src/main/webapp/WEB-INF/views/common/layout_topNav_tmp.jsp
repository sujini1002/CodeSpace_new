...
<nav class="navbar navbar-light  bg-light justify-content-between" style="background-color: #4d8db9; border-radius: 0px" >
  <!-- Navbar content -->
   <a class="navbar-brand" href="${pageContext.request.contextPath}" style="text-decoration: none;color:white">CODESPACE</a>
   <form class="form-inline" action="${pageContext.request.contextPath}/search/searchResults">
    <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="mainSearch">
